...
const (
	...
	annotation = "registry-proxy-operator.kyma-project.io/managed-by-registry-proxy-operator-disclaimer"
	message    = "DO NOT EDIT - This resource is managed by RegistryProxy-Operator.\nAny modifications are discarded and the resource is reverted to the original state."
)
...
func DeleteReconcilerDisclaimer(client client.Client, config rest.Config, obj unstructured.Unstructured) error {
	...
	helper := resource.
		...
		DryRun(false).
		WithFieldManager("registry-proxy-operator")
